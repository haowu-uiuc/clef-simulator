...
expNames = {'full_link_flat_20170208',...
    'full_link_burst_4_20170208', 'full_link_burst_2_20170208',...
    'full_link_burst_1_20170208', 'full_link_burst_5_20170208'};
% expNames = {'full_link_burst_1_20170208'};
% expNames = {'for_paper_flat_20161026'};
...
%         fig = figure;
        ...
        contourf(X, Y, total_damageMatrix, n, 'LineWidth',lineWidth, 'lineStyle', lineStyle);
        colormap(cmap);
...
%         saveas(fig, [fig_dir, routerName, '-total-damage.eps'], 'epsc');
        ...
        if draw_be_damage
        fig = figure;
        contourf(X, Y, be_damageMatrix, n, 'LineWidth',lineWidth, 'lineStyle', lineStyle);
        colormap(cmap);
        set(gca,'YTick',log10(yt),'YTickLabel',ytl);
        set(gca,'color',default_constant_color);
        set(gcf,'Position',[100 100 265 160]);
        ...
        if draw_fp_damage
        fig = figure;
        contourf(X, Y, fp_damageMatrix, n, 'LineWidth',lineWidth, 'lineStyle', lineStyle);
        colormap(cmap);
        set(gca,'YTick',log10(yt),'YTickLabel',ytl);
        set(gca,'color',default_constant_color);
        set(gcf,'Position',[100 100 265 160]);
        ...
        if draw_qd_damage
        fig = figure;
        contourf(X, Y, qd_damageMatrix, n, 'LineWidth',lineWidth, 'lineStyle', lineStyle);
        colormap(cmap);
        set(gca,'YTick',log10(yt),'YTickLabel',ytl);
        set(gca,'color',default_constant_color);
        set(gcf,'Position',[100 100 265 160]);
        ...
        if draw_fp
        fig = figure;
        contourf(X, Y, FPMatrix, n, 'LineWidth',lineWidth, 'lineStyle', lineStyle);
        colormap(cmap);  
        set(gca,'YTick',log10(yt),'YTickLabel',ytl);
        set(gca,'color',default_constant_color);
        set(gcf,'Position',[100 100 265 160]);
        ...
        fig = figure;
        contourf(X, Y, TPMatrix, n, 'LineWidth',lineWidth, 'lineStyle', lineStyle);
        colormap(cmap); 
        set(gca,'YTick',log10(yt),'YTickLabel',ytl);
        set(gca,'color',default_constant_color);
        set(gcf,'Position',[100 100 265 160]);
        ...
        if draw_fn
        fig = figure;
        contourf(X, Y, FNMatrix, n, 'LineWidth',lineWidth, 'lineStyle', lineStyle);
        colormap(cmap); 
        set(gca,'YTick',log10(yt),'YTickLabel',ytl);
        set(gca,'color',default_constant_color);
        set(gcf,'Position',[100 100 265 160]);
