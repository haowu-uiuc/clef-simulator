...
public class Main_MaxPacketLossEvaluation {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Network config
        int inboundLinkCapacity = 250 * 1000 * 1000; // Byte / sec
        int outboundLinkCapacity = 25 * 1000 * 1000; // Byte / sec
        int timeInterval = 10; // seconds, length of packet stream
        int maxPacketSize = NetworkConfig.maxPacketSize;
        
        // for flow generator
        int perFlowReservation = outboundLinkCapacity / 250; // per-flow reservation bandwidth
        int fullRealFlowPacketSize = 500; // packet size of synthetic full real flows
        int numOfFullRealFlows = 135;     // number of real flows fully use the reservation
        int numOfUnderUseRealFlows = 15; // number of real flows under use the reservation
...
//        egDetector.enableDebug();
        ...
        // setup evaluator
        int maxAtkRate = largeFlowRate * 100;
        int minAtkRate = largeFlowRate;
        int atkRateInterval = largeFlowRate;
